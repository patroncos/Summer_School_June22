---
title: "<span style = 'font-size: 85%; color: white'>Introduction to Multilevel Modelling</span>"
subtitle: "<span style = 'font-size: 80%;'>SGSSS Summer School 2022</span>"
author: "Patricio Troncoso & Ana Morales-Gómez<br><span style = 'font-size: 60%;'>Heriot-Watt University<br>University of Edinburgh<br>Scottish Centre for Administrative Data Research (SCADR)</span>" 
output:
...
knitr::include_graphics("https://i-sphere.site.hw.ac.uk/wp-content/uploads/sites/15/2021/01/PATRICIO-e1611159639790-225x300.jpg")
...
knitr::include_graphics("https://pbs.twimg.com/profile_images/1326811878752997376/7dvI51qy_400x400.jpg")
...
(p1 <- ggplot(data, aes(x=x, y=y)) + geom_point(colour="black", size=3) +
  theme_classic() + labs(x="Independent variable", y="Dependent variable"))
...
knitr::include_graphics("https://media3.giphy.com/media/37QUVxlBIduYqVVAjV/giphy.gif?cid=ecf05e47c1qerhqs6rgcvc7bl45kmwz3veb4ob4wqdmr4niv&rid=giphy.gif&ct=g")
...
```{r, out.width = '65%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/exreg1.png")
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '45%', echo = FALSE, fig.align="center"}

(p2 <- p1 + geom_smooth(se=F, colour="red", method="lm"))
...
(p3 <- ggplot(data, aes(x=x, y=y)) + geom_smooth(se=F, colour="red", method="lm") + 
  ...
  geom_hline(yintercept = 0) +
    ...
    annotate("text", x = -1, y = 3.4, label = "Intercept = 2.07") +
    annotate("text", x = 1.5, y = 3.4, label = "Slope = 3.14") +
    geom_segment(aes(x = -1, y = 3, xend = 0, yend = 2.07),
                 size = 1,
                 arrow = arrow(length = unit(0.2, "cm")),
                 colour = "blue") +
    geom_segment(aes(x = 1, y = 2.07, xend = 1, yend = 5.2),
                 size = 1,
                 linetype = "dashed",
                 colour = "blue") +
    geom_segment(aes(x = 0, y = 2.07, xend = 1, yend = 2.07),
                 size = 1,
                 linetype = "dashed",
                 colour = "blue")
  )
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/reg1.PNG")
```
--
...
library(R2MLwiN)
data("tutorial")
summary(lm(normexam ~ standlrt + factor(sex), data= tutorial))$coefficients
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '75%', out.hight = '80%', echo = FALSE, fig.align="center"}

knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/norm1.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '75%', out.hight = '80%', echo = FALSE, fig.align="center", fig.cap="Source: Laerd Statistics"}

knitr::include_graphics("https://statistics.laerd.com/spss-tutorials/img/lr/heteroscedastic-relationships.png")
```
---
## MLR Assumptions (3)
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '30%', echo = FALSE, fig.align="center"}
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/structure1.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/structure2.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/structure3.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/structure4.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '80%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://ars.els-cdn.com/content/image/1-s2.0-S0022440521000546-gr2.jpg")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '40%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/structure6.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '40%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/structure5.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '40%', echo = FALSE, fig.align="center", fig.cap="Source: LEMMA course Bristol University"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/whatislevel.PNG")
```
--
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '60%', echo = FALSE, fig.align="center", fig.cap=""}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/resid1.PNG")
```
---
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '60%', echo = FALSE, fig.align="center", fig.cap=""}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/resid2.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '70%', echo = FALSE, fig.align="center", fig.cap=""}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/resid3.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '70%', echo = FALSE, fig.align="center", fig.cap=""}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/resid4.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center", fig.cap=""}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/vpc2.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '70%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/vpc1.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '70%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/randint1.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/randint2.PNG")
```
]
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/randint3.PNG")
```
]
...
mydata <- read.table("https://raw.githubusercontent.com/A-mora/MLM_summer-school/main/data/antenatal.txt",  
                     header = TRUE, sep = ",")
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '70%', echo = FALSE, fig.align="center", fig.cap=""}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/randslop1.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '70%', echo = FALSE, fig.align="center", fig.cap=""}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/randslop2.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/randslop3.PNG")
```
]
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '70%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/randslop4.PNG")
```
...
```{r, echo=FALSE, warnings= F, message = F, out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("https://raw.githubusercontent.com/patroncos/Summer_School_June22/main/images/randslop5.PNG")
```
...
```{r, echo=FALSE, fig.align= "center", out.width="160px", fig.cap=" -'I see MLMs!'", message=F, warning=F}
